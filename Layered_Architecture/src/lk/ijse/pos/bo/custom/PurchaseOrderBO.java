...
public interface PurchaseOrderBO extends SuperBO{
    ...
    boolean purchaseOrder(OrderDTO dto/*String orderId, LocalDate orderDate, String customerId, List<OrderDetailDTO> orderDetails*/) throws SQLException, ClassNotFoundException;
